...
function SettingRightSection({ setVisibility, tag, setTag }: Props) {
  ...
  const { delTeg, insertTag, changePostSeries, insertSeries, delSeries } = myFunctions();
            ...
            <div className="contents">
              {selectedPostSeries === null ? (
                ...
                <div className="sd-qqww">
                  ...
                  <button
                    className="seriesDelBtn"
                    type="button"
                    onClick={() => delSeries(setSelectSeries, setSelectedPostSeries)}
                  >
                    제거하기
                  </button>
                </div>
