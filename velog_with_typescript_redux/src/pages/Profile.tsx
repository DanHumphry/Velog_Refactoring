...
function Profile() {
  ...
  const [nicknmaModal, setNickname] = useState(false);
  const [socialModal, setSocialModal] = useState(false);

  const [userPhoto, setUserPhoto] = useState();
  const [userEmail, setUserEmail] = useState('');
  const [userMygit, setUserMygit] = useState('');
        ...
        <div className="myProfile">
          <div className="wrapper">
            ...
            <div className="block-for-mobile">
              {nicknmaModal === true ? null : <div className="contents">{userNickname}</div>}

              {nicknmaModal === true ? (
                <form className="nickname-form">
                  <input className="nickname-input" placeholder={userNickname} />
                </form>
              ) : (
